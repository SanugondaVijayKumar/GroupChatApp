...
window.addEventListener("DOMContentLoaded", async(e)=>{
    try{
        ...
        const response = await axios.get("http://localhost:3000/get-groups",{headers:{"Authorization": token}});
...
create.onclick = async(e)=>{
    try{
        ...
        const token = localStorage.getItem('token');
        const response = await axios.post("http://localhost:3000/add-group",obj,{headers:{"Authorization": token}});
        //console.log(response);
