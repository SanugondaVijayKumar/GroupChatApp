...
window.addEventListener("DOMContentLoaded", async(e)=>{
    try{
        ...
        const alluserData = await axios.get("http://localhost:3000/view-users-of-group",{headers:{"Authorization": token}});
...
async function senduserData(sendData){
    try{
        ...
        const response = await axios.post(`http://localhost:3000/add-user-to-group`, myobj,{headers:{"Authorization": token}});
